...
public class DataTransformer : EditorWindow
{
	...
	public static void ParseExcelDataToJson()
	{
		...
		ParseExcelDataToJson<EnemyDataLoader, EnemyData>("Enemy");
		ParseExcelDataToJson<EquipmentDataLoader, EquipmentData>("Equipment");
		ParseExcelDataToJson<DefaultSkillDataLoader, DefaultSkillData>("DefaultSkill");
		ParseExcelDataToJson<SkillADataLoader, SkillAData>("SkillA");
		ParseExcelDataToJson<SkillBDataLoader, SkillBData>("SkillB");
		ParseExcelDataToJson<LevelMaterialDataLoader, LevelMaterialData>("LevelMaterial");
